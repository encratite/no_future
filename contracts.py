...
CONTRACT_CONFIGURATION: Final[dict[str, ContractFilter]] = {
	...
	"ES": ContractFilter(copy="MES", legacy_cutoff="ESU02"),
	"ET": ContractFilter("MES"),
	"FA": ContractFilter("FESB"),
	"FX": ContractFilter("FESX", legacy_cutoff="FXU02"),
	"GC": ContractFilter(copy="MGC", legacy_cutoff="GCG06", exclude_months=["F", "H", "K", "N", "U", "V", "X"]),
	"GF": ContractFilter(legacy_cutoff="GFH01", cutoff_date="2004-12-04"),
	"GG": ContractFilter("FGBL", legacy_cutoff="GGZ01"),
	"GR": ContractFilter("MGC", exclude_months=["V"]),
	"HE": ContractFilter(legacy_cutoff="HEJ02", cutoff_date="2002-03-02"),
	"HF": ContractFilter("FGBS", legacy_cutoff="HFZ01"),
	...
	"HR": ContractFilter("FGBM", legacy_cutoff="HRZ01"),
	...
	"M6": ContractFilter("6M", include_months=["H", "M", "U", "Z"]),
